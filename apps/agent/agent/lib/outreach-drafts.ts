		...
		try {
			const prompt = JSON.stringify({
				...
				stageIntents: [
					...
					"Close with a direct, brief connection between the published operation and chosen capability. Do not recap the company fact or vehicle list. Named target: name the selected capability in the question and offer to leave it there. Code inserts the department closing question.",
				],
				sequenceGuidance: {
					continuity:
